...
public class LimitExpression 
{
	...
	private static final double mutationRate = 0.015;//should be .015
	private static final double expansionRate = .2; //under normal parameters, how likely is a gene to expand?
	private static final double regressionRate = .66;//under normal parameters, how likely is a gene to regress?
	private static final double substitutionRate = 1.0;//............................................. be substituted?
	private static final int maxSize = 20;
	private static final int minSize = 6;
	private static final int maxRegression = 3; //determines how much information can be regressed at a time.
			...
			if (Math.random() <= mutationRate)
            {
				...
				if(mutationType == 0)//expansion
				{
					...
					else if(expansionStep == 2)//if expanding by a binary operator
					{
						...
						int intPiOrE = gen.nextInt(3); 	  //if varOrNum is 1, choose what that number should be.
						Expression newExp1;
						Expression newExp2;
						if(leftOrRight == 0)
						{
							...
							else
							{
								...
								switch(intPiOrE)
								{
								case 0: newExp1 = new Number(gen.nextInt(1000)); break;
								case 1: newExp1 = new Number(Math.PI); break;
								case 2: newExp1 = new Number(Math.E); break;
								default: System.out.println("problem in BinaryExpansion when choosing a Number.");
								newExp1 = new Number(gen.nextInt(1000));
								}
								newExp2 = current;
							}
						}
						else
						{
							...
							else
							{
								...
								switch(intPiOrE)
								{
								case 0: newExp2 = new Number(gen.nextInt(1000)); break;
								case 1: newExp2 = new Number(Math.PI); break;
								case 2: newExp2 = new Number(Math.E); break;
								default: System.out.println("problem in BinaryExpansion when choosing a Number (exp2).");
								newExp2 = new Number(gen.nextInt(1000));
								}
								newExp1 = current;
							}
						}
				...
				else if(mutationType == 2)//substitution
				{
					...
					if(current.getExpType().equalsIgnoreCase("Number") || current.getExpType().equalsIgnoreCase("Variable"))
					{
						...
						switch(intPiOrE)
						{
						case 0: newLeafValue = gen.nextInt(1000);break;
						case 1: newLeafValue = Math.PI;break;
						case 2: newLeafValue = Math.E;break;
						default: newLeafValue = Math.PI; System.out.println("Problem in substitution when determining newLeafValue.");
						}
